package io.tezos.octezconnect.transport.p2p.matrix.data
...
import io.tezos.octezconnect.transport.p2p.matrix.internal.migration.v3_2_0.MatrixRoomSerializer
