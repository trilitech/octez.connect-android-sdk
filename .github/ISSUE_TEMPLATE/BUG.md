...
- [ ] I've seen [the docs](https://docs.walletbeacon.io) and [the demo code](https://github.com/trilitech/octez.connect-android-sdk/tree/master/demo). <!-- Not a must, but consider checking them if you haven't already. -->
